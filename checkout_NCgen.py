""" Script to check out the results from the DSNB-NC generator of Jie Cheng with the original GENIE file of Julia.
    ...
    Is it really from 0 to 10 GeV OR from 100 MeV to 10 GeV? -> 10 MeV to 10 GeV
...
# if SAVE_TXT:
#     np.savetxt(output_path + "combined_channels_NC_onlyC12_{0:.0f}evts.txt"
#                .format(250000),
#                np.array([250000, num_c12, num_no_c12,
#                          num_b11, num_b11_n_piplus, num_b11_p,
#                          num_c11, num_c11_n, num_c11_p_piminus,
#                          num_c10, num_c10_2n, num_c10_n_p_piminus,
#                          num_b10, num_b10_n_p,
...
#                       "(final particles after NC interaction and after deexcitation), for all 250000 events\n"
#                       "(input file: {0}, script: checkout_NCgen.py ({1})):\n"
#                       "number of entries in the input file,\n"
#                       "number of events with C12 as target,\n"
#                       "number of events without C12 as target,\n"
