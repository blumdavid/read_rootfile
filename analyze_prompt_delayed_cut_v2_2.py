...
for filenumber in range(start_number, stop_number+1):
    ...
    for event in range(number_events):
        ...
        # analysis):
        npe_per_hittime_save_prompt = [min_time_total, 1000.0+20.0, binwidth]
...
np.savetxt(output_path_del + 'filenumber_evtID_delayed_cut_{0}_{1:.0f}ns_to_{2:.0f}ms_mult{3:d}_{4:.0f}PE_{5:.0f}PE_'
...
np.savetxt(output_path_del + 'filenumber_evtID_delayed_cut_MCtruth_{0}_{1:.0f}ns_to_{2:.0f}ms_mult{3:d}_{4:.0f}PE_'
